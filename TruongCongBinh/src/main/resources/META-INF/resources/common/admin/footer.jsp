    ...
    <%@ include file="/common/taglib.jsp" %>
        ...
        <style>
            ...
            .footer-glassmorphism::before {
                ...
                width: 100%;
                height: 100%;
                background: linear-gradient(135deg, rgba(52, 211, 153, 0.15) 0%, rgba(34, 197, 94, 0.15) 100%);
                z-index: -1;
            }
            ...
            .social-icon:before {
                ...
                width: 100%;
                height: 100%;
                background: linear-gradient(45deg, rgba(52, 211, 153, 0.5), rgba(34, 197, 94, 0.5));
                opacity: 0;
            ...
            <div class="container text-center">
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <span>Họ tên: Trương Công Bình</span>
                    </div>
                    <div class="contact-item">
                        <span class="contact-icon"><i class="fa fa-info"></i></span>
                        <span>MSSV: 23110184</span>
                    </div>
                    <div class="contact-item">
                        <span class="contact-icon"><i class="fa fa-info"></i></span>
                        <span>Mã đề: 12</span>
