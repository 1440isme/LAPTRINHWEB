                                ...
                                <form action="${pageContext.request.contextPath}/admin/category/update" method="post"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="status" name="status" class="form-select">
                                            <option value="1" ${category.status==1 ? 'selected' : '' }>Kích hoạt
                                            </option>
                                    ...
                                    <div class="mb-3">
                                        <label for="image" class="form-label">Chọn hình ảnh mới (để trống nếu không thay
                                            đổi)</label>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <button type="submit" class="btn btn-warning"><i class="fa fa-save me-1"></i>Cập
                                            nhật</button>
                                        <a href="${pageContext.request.contextPath}/admin/categories"
                                            class="btn btn-outline-secondary"><i class="fa fa-arrow-left me-1"></i>Quay
                                            lại</a>
                                    </div>
                                </form>
                            </div>
